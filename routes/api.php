...
Route::group(['middleware' => ['jwt.verify']], function() {
    ...
    Route::group(['prefix' => 'peminjaman_t'], function() {
        Route::get('get-data', [PeminjamanController::class, 'getPeminjaman']);
        Route::post('save-data', [PeminjamanController::class, 'savePeminjaman']);
        Route::delete('delete-data', [PeminjamanController::class, 'deletePeminjaman']);
    });
});
